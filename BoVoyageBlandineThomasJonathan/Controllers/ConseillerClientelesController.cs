...
namespace BoVoyageBlandineThomasJonathan.Controllers
{
    public class ConseillerClientelesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Mail,Password,ConfirmedPassword,Nom,Prenom,Adresse,Telephone,DateDeNaissance,Age,CivilityID")] ConseillerClientele conseillerClientele)
        {
            if (ModelState.IsValid)
            {
